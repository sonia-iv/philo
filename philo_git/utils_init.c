...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/10/18 17:03:40 by sivashch          #+#    #+#             */
/*   Updated: 2025/10/18 17:05:25 by sivashch         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		int *atoi_err)
{
	if (ac == 6)
	{
		...
		if (*atoi_err || !(pars_args->opt_num_of_meals >= 1 \
			&& pars_args->opt_num_of_meals <= 200))
			return (1);
		else
			return (0);
	}
